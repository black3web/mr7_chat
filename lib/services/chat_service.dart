...
class ChatService {
  ...
  Future<ChatModel> getOrCreateChat(String userId1, String userId2) async {
    ...
    final doc = await _firestore.collection(AppConstants.chatsCollection).doc(chatId).get();
    ...
    await _firestore.collection(AppConstants.chatsCollection).doc(chatId).set(chat.toMap());
    return chat;
  }
  ...
  Future<void> deleteChat(String chatId) async {
    ...
    batch.delete(_firestore.collection(AppConstants.chatsCollection).doc(chatId));
    await batch.commit();
  }
