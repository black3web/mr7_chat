...
class _ImageGenScreenState extends State<ImageGenScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // تعريف التدرجات يدوياً لضمان عدم حدوث خطأ إذا لم تكن موجودة في AppGradients
...
class _NanoBananaProTabState extends State<_NanoBananaProTab> {
  ...
  Widget build(BuildContext context) {
    final l = AppLocalizations.of(context);
    const accentGradient = LinearGradient(colors: [Color(0xFFE91E63), Color(0xFFC2185B)]);
          ...
          Expanded(
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: !_editMode ? accentGradient : null, 
                  color: _editMode ? AppColors.bgLight : null, 
        ...
        if (_inputImageUrl != null) ...[
          GlassContainer(
            ...
            child: Column(children: [
              ...
              const Text('صورة المدخل - اكتب تعليمات التعديل ادناه', style: TextStyle(color: AppColors.textMuted, fontSize: 12)),
            ]),
          ),
          const SizedBox(height: 12),
        ],
          ...
          child: Row(children: _ratios.map((r) => Padding(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: _ratio == r ? accentGradient : null, 
                  color: _ratio == r ? null : AppColors.bgLight, 
                  borderRadius: BorderRadius.circular(20), 
                  border: Border.all(color: _ratio == r ? const Color(0xFFE91E63) : AppColors.glassBorder)
                ),
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12), 
                border: Border.all(color: _resolution == r ? const Color(0xFFE91E63) : AppColors.glassBorder)
              ),
