    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SafeArea(child: Column(children: [
          _AiHeader(title: 'Video Generator', subtitle: 'AI Video Creation', color: const Color(0xFF9C27B0), icon: Icons.videocam_rounded),
          Container(
  ...
  Widget build(BuildContext context) {
    ...
    return ClipRRect(
      ...
      child: Stack(children: [
        ...
        VideoProgressIndicator(_ctrl, allowScrubbing: true, colors: VideoProgressColors(playedColor: AppColors.accent, bufferedColor: AppColors.primary.withOpacity(0.4), backgroundColor: Colors.white12)),
      ]),
    );
  }
}